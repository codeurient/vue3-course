<template>
    <div>
        <!-- 
            1) GETTERS icinde yazdigimiz funksiyalari cagirmaq ucun GETTERS acar sozunden istifade edilir. Hemin funksiya icinde 
            yazilan funksiyalar YUMRU () morterize olmadan cagrilir.
        -->

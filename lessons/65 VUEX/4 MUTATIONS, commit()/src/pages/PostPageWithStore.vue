<template>
    <div>
        <!-- 
            1) MUTATIONS funksiyalarini komponentlerde cagirmaq ucun COMMIT() funksiyasindan istifade edilir. Bu funksiyanin parametri, bizim 
            cagirmaq istediyimiz MUTATIONS funksiyasinin adini string kimi qebul edir. 
        -->
        <h1> {{ $store.getters.doubleLikes }} </h1>
        <div>
            <my-button @click="$store.commit('incrementLikes')">Like</my-button>
            <my-button @click="$store.commit('decrementLikes')">Deslike</my-button>
        </div>
